$(window).load(function() {
	...
	var testimoial_timeout, testimonial_duration = 5000;
	testimoial_timeout = setTimeout(function() { $('.testimonials .icon-right-open').trigger('click'); }, testimonial_duration);
	$('.testimonials .icon-right-open').click(function() {
		window.clearTimeout(testimoial_timeout);
	...
	var capnum1 = (Math.floor(Math.random() * 10)) + 1;
	var capnum2 = (Math.floor(Math.random() * 10)) + 1;
	$('#captcha span').text(capnum1 + " + " + capnum2);
	$('form input[name="capnum1"]').val(capnum1);
	$('form input[name="capnum2"]').val(capnum2);
	...
	$('form input[type="submit"]').on('click', function() {
		...
		if(capnum1 + capnum2 != $('form input[name="capresult"]').val()) {
			hasError = true;
			errorMsg += "Human validation result is incorrect. ";
		}
		...
		'&phone=' + phone +
		'&message=' + messg + 
		'&capnum1=' + $('form input[name="capnum1"]').val() +
		'&capnum2=' + $('form input[name="capnum2"]').val() +
		'&capresult=' + $('form input[name="capresult"]').val();
