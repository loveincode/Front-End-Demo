...
function myPieChart(){
    var myPieChart = echarts.init(document.getElementById('park-info-chart'));
    option = {
        ...
        series : [
            {
                ...
                data:[
                    {value:335, name:'其他'},
                    {value:310, name:'石油化工企业'},
                    {value:274, name:'公用工程企业'},
                    {value:400, name:'生产配套服务'}
...
function myKLineChart(){
    var myKLineChart = echarts.init(document.getElementById('trend-analysis'));
    option = {
        /*title : {
            text: '2013年上半年上证指数'
        },*/
    	    ...
    	    xAxis : [
    	        {
    	            type : 'category',
    	            boundaryGap : false,
    	            data : ['201604','201605','201606','201607','201608','201609','201610']
    	        }
    	    ],
    	    yAxis : [
    	        {
